...
/* Popover options for buttons */
// HTML code to add for the buttons to enable popovers
// <button type ="button" class="btn btn-primary" data-bs-toggle="popover" title="Popover Header" data-bs-content="Some content inside the popover"> </button>
var popoverTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]'))
var popoverList = popoverTriggerList.map(function (popoverTriggerEi) {
    return new bootstrap.Popover(popoverTriggerEi)
})

/* Button tooltips this can be used with the C# code as well */
// HTML code to add for the buttons to enable tooltips
// <button type="button" class="btn btn-primary" data-bs-toggle="tooltip" title="Horray"> Button Name </button>
var tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
var tooltipList = tooltipTriggerList.map(function (tooltipTriggerEi) {
    return new bootstrap.Tooltip(tooltipTriggerEi)
})
